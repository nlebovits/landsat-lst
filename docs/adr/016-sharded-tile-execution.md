...
barrier waits for the slowest one; the shares come from the same `climatology_groups`
split the shards use, since an even division understates the widest group on a coastal
